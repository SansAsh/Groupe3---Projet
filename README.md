...
Projet SI en Java : construire une API, structurée, documentée et testée, avec un workflow Git.

## Objectifs

- Mettre en place un dépôt Git propre (`main`/`develop`/`feature/*`)
- Avoir un MVP (auth + gestion de ressources métier)
...
- DONATI Gabrielle - PO,Lead Dev
- LAQUAYE Remi - dev
- POUILLAUD Mathieux - QA, dev
- NOUFFEL Baptiste - dev
